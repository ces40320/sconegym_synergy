...
scenario_template = r'''
ModelHyfydy {{
  model_file = H2190v2k_sota.hfd
  state_init_file = InitStateGait10_uneven.zml
...
output_dir = r"C:\Users\ok\anaconda3\envs\scone_rl\Lib\site-packages\sconegym\data-v1\random_terrain"
for i in range(1, 1001):
    blueprint = generate_blueprint()
    content = scenario_template.format(
        model_file=r'C:\Users\ok\anaconda3\envs\scone_rl\Lib\site-packages\sconegym\data-v1\H2190v2_sota.hfd',
        blueprint=blueprint
    )
